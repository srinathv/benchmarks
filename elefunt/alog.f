...
C
C         ABS, ALOG, ALOG10, AMAX1, FLOAT, SIGN, SQRT
C
C
...
C
     ...
     1        MAXEXP,MINEXP,N,NEGEP,NGRD
      REAL A,AIT,ALBETA,B,BETA,C,DEL,EIGHT,EPS,EPSNEG,HALF,ONE,
     1     RAN,R6,R7,TENTH,W,X,XL,XMAX,XMIN,XN,X1,Y,Z,ZERO,ZZ
C
      IOUT = 6
...
C
  ...
  110       IF (J .NE. 3) GO TO 120
            ...
            Y = X + X * TENTH
            Z = ALOG10(X)
            ZZ = ALOG10(Y) - 3.7706015822504075E-4
...
C-----------------------------------------------------------------
      ...
      WRITE (IOUT,1100)
      STOP
 1000 FORMAT(47H1TEST OF ALOG(X) VS T.S. EXPANSION OF ALOG(1+Y)  //)
 1001 FORMAT(44H1TEST OF ALOG(X) VS ALOG(17X/16)-ALOG(17/16)   //)
 1002 FORMAT(32H1TEST OF ALOG(X*X) VS 2 * LOG(X)  //)
 1005 FORMAT(50H1TEST OF ALOG10(X) VS ALOG10(11X/10)-ALOG10(11/10) //)
 ...
 1011 FORMAT(19H ALOG(X) WAS LARGER,I6,7H TIMES, /
     1     12X,7H AGREED,I6,11H TIMES, AND /
     2     8X,11HWAS SMALLER,I6,7H TIMES.//)
 1012 FORMAT(21H ALOG10(X) WAS LARGER,I6,7H TIMES, /
 ...
 1030 FORMAT(52H THE IDENTITY  ALOG(X) = -ALOG(1/X)  WILL BE TESTED.//
     1      8X,1HX,9X,13HF(X) + F(1/X)/)
 1040 FORMAT(//26H TEST OF SPECIAL ARGUMENTS //)
 1041 FORMAT(13H ALOG(1.0) = ,E15.7//)
 1042 FORMAT(19H ALOG(XMIN) = ALOG(,E15.7,4H) = ,E15.7//)
 1043 FORMAT(19H ALOG(XMAX) = ALOG(,E15.7,4H) = ,E15.7//)
 1050 FORMAT(22H1TEST OF ERROR RETURNS//)
 1052 FORMAT(38H ALOG WILL BE CALLED WITH THE ARGUMENT,E15.4/
     1       37H THIS SHOULD TRIGGER AN ERROR MESSAGE//)
 1055 FORMAT(24H ALOG RETURNED THE VALUE,E15.4///)
 1060 FORMAT(2E15.7/)
 1100 FORMAT(25H THIS CONCLUDES THE TESTS )
C     ---------- LAST CARD OF ALOG/ALOG10 TEST PROGRAM ----------
      END
      REAL FUNCTION REN(K)
C
