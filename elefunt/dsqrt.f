...
C
     ...
     1        MAXEXP,MINEXP,N,NEGEP,NGRD
      REAL*8 A,AIT,ALBETA,B,BETA,C,EPS,EPSNEG,ONE,RANDL,R6,R7,
     1     SQBETA,W,X,XMAX,XMIN,XN,X1,Y,Z,ZERO
C
      IOUT = 6
...
C-----------------------------------------------------------------
      ...
      WRITE (IOUT,1100)
      STOP
 1000 FORMAT(23H1TEST OF DSQRT(X*X) - X //)
 ...
 1041 FORMAT(21H DSQRT(XMIN) = DSQRT(,E15.7,4H) = ,E15.7//)
 1042 FORMAT(27H DSQRT(1-EPSNEG) = DSQRT(1-,E15.7,4H) = ,E15.7//)
 1043 FORMAT(20H DSQRT(1.0) = DSQRT(,E15.7,4H) = ,E15.7//)
 1044 FORMAT(24H DSQRT(1+EPS) = DSQRT(1+,E15.7,4H) = ,E15.7//)
 1045 FORMAT(21H DSQRT(XMAX) = DSQRT(,E15.7,4H) = ,E15.7//)
 1050 FORMAT(22H1TEST OF ERROR RETURNS//)
 1051 FORMAT(39H DSQRT WILL BE CALLED WITH THE ARGUMENT,E15.4/
     1       41H THIS SHOULD NOT TRIGGER AN ERROR MESSAGE//)
 1052 FORMAT(39H0DSQRT WILL BE CALLED WITH THE ARGUMENT,E15.4/
     1       37H THIS SHOULD TRIGGER AN ERROR MESSAGE//)
 1055 FORMAT(25H DSQRT RETURNED THE VALUE,E15.4///)
